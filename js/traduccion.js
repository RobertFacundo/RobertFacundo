function cambiarIdiomaEspañol() {
    ...
    document.getElementById("l2").textContent = "Descargar";
    ...
    document.getElementById("l4").textContent = "Descargar";
    ...
    document.getElementById("l6").textContent = "Descargar";
    ...
    document.getElementById("l8").textContent = "Descargar";
    ...
    document.getElementById("l10").textContent = "Descargar";
    ...
    document.getElementById("l12").textContent = "Descargar";
    ...
    document.getElementById("l14").textContent = "Descargar";
...
function cambiarIdiomaInglés() {
    ...
    document.getElementById("l2").textContent = "Download";
    ...
    document.getElementById("l4").textContent = "Download";
    ...
    document.getElementById("l6").textContent = "Download";
    ...
    document.getElementById("l8").textContent = "Download";
    ...
    document.getElementById("l10").textContent = "Download";
    ...
    document.getElementById("l12").textContent = "Download";
    ...
    document.getElementById("l14").textContent = "Download";
